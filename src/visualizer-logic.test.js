...
// Mock model data
const mockVocab = [
    'the', 'a', 'an', 'cat', 'dog', 'in', 'on',
    'house', 'tree', 'jumped', 'ran', 'slept'
];
...
describe('visualizer-logic', () => {
    ...
    describe('performBeamStep', () => {
        it('should perform one beam step correctly', () => {
            const beam = [{ sequence: [0], score: 0.0 }]; // 'the'
        ...
        it('should return unchanged beam if at end', () => {
            const beam = [{ sequence: [0, 3], score: 0.0 }];
    ...
    describe('getStepCandidates', () => {
        ...
        it('should get candidates based on last word in path', () => {
            const path = { sequence: [0], score: 0.0 }; // 'the'
            const targetChars = ['t', 'c'];
            const step = 1;
        ...
        it('should return empty array if past end', () => {
            const path = { sequence: [0], score: 0.0 };
            const targetChars = ['t'];
            const step = 1;
    ...
    describe('handleWordSelection', () => {
        it('should handle normal word selection', () => {
            const userPath = { sequence: [], score: 0.0 };
            const wordId = 0; // 'the'
            const score = 0.0;
            const currentStep = 0;
        ...
        it('should handle sentence break selection', () => {
            const userPath = { sequence: [0, 3], score: -0.5 };
        ...
        it('should accumulate scores correctly', () => {
            const userPath = { sequence: [0], score: -1.0 };
            const wordId = 3;
            const score = -0.5;
            const currentStep = 1;
    ...
    describe('Integration: manual mode workflow', () => {
        it('should correctly initialize and advance through manual mode', () => {
            ...
            const selection1 = handleWordSelection(currentUserPath, candidates1[0][0], candidates1[0][1], currentStep);
            ...
            const selection2 = handleWordSelection(currentUserPath, candidates2[0][0], candidates2[0][1], currentStep);
